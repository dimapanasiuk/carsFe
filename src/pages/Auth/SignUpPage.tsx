    ...
    <div className="min-h-screen bg-white flex items-center justify-center px-4">
      <div className="w-full max-w-lg">
        ...
        <div className="text-center mb-10">
          <h1 className="text-3xl font-bold text-gray-900 mb-4">Get's started.</h1>
        ...
        <div className="space-y-8">
          ...
          {/* Registration Form */}
          <form onSubmit={handleSubmit} className="bg-white p-6 rounded-xl border border-gray-200 shadow-lg">
            <div className="space-y-4">
              {/* First Name */}
              <div>
